...
const FIXTURE_STANDS: RegistrationStand[] = [
  ...
  buildStand("Standard 4", "standard", 81.99, 28.23, 3.56, 3.07, 40),
  buildStand("Standard 5", "standard", 89.53, 29.69, 5.84, 1.91, 50),
  buildStand("Standard 6", "standard", 89.48, 32.88, 5.84, 1.87, 60),
