...
const FIXTURE_STANDS: RegistrationStand[] = [
  ...
  buildStand("Standard 4", "standard", 90.47, 24.78, 3.39, 3.0, 40),
  buildStand("Standard 5", "standard", 80.08, 26.56, 3.5, 3.0, 50),
  buildStand("Standard 6", "standard", 90.57, 29.17, 3.6, 3.0, 60),
