...
values
  ('66666666-0000-0000-0000-000000000001', 'Sara Nguyen', 'sara1@example.com', 'Informatikk', 'Bachelor', 2027, array['Sommerjobb'], array['Informatikk', 'Frontend'], array['Læring', 'Autonomi'], array['Oslo'], false, array['22222222-2222-2222-2222-222222222222']),
  ('66666666-0000-0000-0000-000000000002', 'Jonas Berg', 'jonas2@example.com', 'Data science', 'Master', 2026, array['Fulltid'], array['Data science', 'Analyse'], array['Bærekraft'], array['Oslo', 'Trondheim'], true, array['22222222-2222-2222-2222-222222222222']),
  ('66666666-0000-0000-0000-000000000003', 'Maja Olsen', 'maja3@example.com', 'Økonomi', 'Bachelor', 2028, array['Deltid'], array['Økonomi', 'Analyse'], array['Teamwork'], array['Bergen'], false, array['33333333-3333-3333-3333-333333333333']),
  ('66666666-0000-0000-0000-000000000004', 'Filip Larsen', 'filip4@example.com', 'Industriell økonomi', 'Master', 2026, array['Internship', 'Fulltid'], array['Industriell økonomi', 'Strategi'], array['Kundeimpact'], array['Oslo'], true, array['33333333-3333-3333-3333-333333333333']),
  ('66666666-0000-0000-0000-000000000005', 'Emma Sørensen', 'emma5@example.com', 'Informatikk', 'Bachelor', 2027, array['Sommerjobb', 'Internship'], array['Backend', 'Informatikk'], array['Autonomi'], array['Oslo'], false, array['22222222-2222-2222-2222-222222222222']),
  ('66666666-0000-0000-0000-000000000006', 'Noah Hansen', 'noah6@example.com', 'Data science', 'Bachelor', 2028, array['Sommerjobb'], array['Data science'], array['Bærekraft', 'Teamwork'], array['Trondheim'], true, array['22222222-2222-2222-2222-222222222222']),
  ('66666666-0000-0000-0000-000000000007', 'Ingrid Johansen', 'ingrid7@example.com', 'Økonomi', 'Master', 2026, array['Fulltid'], array['Økonomi', 'Konsulent'], array['Kundeimpact'], array['Bergen', 'Oslo'], true, array['33333333-3333-3333-3333-333333333333']),
  ('66666666-0000-0000-0000-000000000008', 'Ali Reza', 'ali8@example.com', 'Informatikk', 'Master', 2026, array['Fulltid'], array['Informatikk', 'Backend'], array['Læring'], array['Oslo'], false, array['22222222-2222-2222-2222-222222222222']),
  ('66666666-0000-0000-0000-000000000009', 'Sofie Dahl', 'sofie9@example.com', 'Industriell økonomi', 'Bachelor', 2027, array['Internship'], array['Strategi', 'Analyse'], array['Teamwork', 'Nysgjerrighet'], array['Oslo'], true, array['33333333-3333-3333-3333-333333333333']),
  ('66666666-0000-0000-0000-000000000010', 'Kristian Moe', 'kristian10@example.com', 'Data science', 'Master', 2026, array['Fulltid'], array['Data science', 'Maskinlæring'], array['Autonomi', 'Bærekraft'], array['Oslo'], true, array['22222222-2222-2222-2222-222222222222'])
on conflict (id) do nothing;
